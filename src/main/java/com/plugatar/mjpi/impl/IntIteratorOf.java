...
/**
 * The {@link IntIterator} implementation based on {@code int} array.
 */
public final class IntIteratorOf implements IntIterator {
     ...
     */
    public IntIteratorOf(final int... items) {
