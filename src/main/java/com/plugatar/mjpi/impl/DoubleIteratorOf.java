...
/**
 * The {@link DoubleIterator} implementation based on {@code double} array.
 */
public final class DoubleIteratorOf implements DoubleIterator {
     ...
     */
    public DoubleIteratorOf(final double... items) {
