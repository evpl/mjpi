...
/**
 * The {@link ShortIterator} implementation based on {@code short} array.
 */
public final class ShortIteratorOf implements ShortIterator {
     ...
     */
    public ShortIteratorOf(final short... items) {
