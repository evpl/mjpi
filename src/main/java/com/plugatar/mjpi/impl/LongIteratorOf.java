...
/**
 * The {@link LongIterator} implementation based on {@code long} array.
 */
public final class LongIteratorOf implements LongIterator {
     ...
     */
    public LongIteratorOf(final long... items) {
