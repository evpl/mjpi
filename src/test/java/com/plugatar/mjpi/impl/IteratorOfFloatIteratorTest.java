...
import com.plugatar.mjfi.FloatFunction;
...
/**
 * Test case for {@link IteratorOfFloatIterator}.
 * <br/>Also used: {@link FloatIteratorOf}, {@link FloatIteratorOfIterator}.
 */
final class IteratorOfFloatIteratorTest {

    @Test
    void ctorThrowsNPEForNullOriginArg() {
        assertThatCode(() -> new IteratorOfFloatIterator<>(null, i -> i))
    ...
    void ctorThrowsNPEForNullConversionFunctionArg() {
        ...
        assertThatCode(() -> new IteratorOfFloatIterator<>(iterator, null))
                .isInstanceOf(NullPointerException.class);
    }

    @Test
    void pecsForCtor() {
        final FloatIterator FloatIterator = new FloatIteratorOf();
        final FloatFunction<Float> function = i -> i;
        final Iterator<Number> iterator = new IteratorOfFloatIterator<>(FloatIterator, function);
    }

    @Test
    void allMethodsUseOriginMethods() {
        final Iterator<Float> iterator = new IteratorOfFloatIterator<>(
                new FloatIterator() {
                    @Override
    ...
    void iterations() {
        ...
        final Iterator<String> iterator = new IteratorOfFloatIterator<>(
                new FloatIteratorOfIterator<>(items.iterator(), Float::parseFloat),
                String::valueOf
        );
