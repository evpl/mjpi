...
/**
 * Test case for {@link DoubleIteratorOfNativeIterator}.
 */
final class DoubleIteratorOfNativeIteratorTest {

    @Test
    void ctorThrowsNPEForNullArg() {
        assertThatCode(() -> new DoubleIteratorOfNativeIterator(null))
                .isInstanceOf(NullPointerException.class);
    }

    @Test
    void allMethodsUseOriginMethods() {
        final DoubleIterator iterator = new DoubleIteratorOfNativeIterator(
